...
public class APFNavigation : MonoBehaviour
{
    public APFAgent APF;
    ...
    private void ComputeNewVelocity(Vector3 waypoint)
    {
        ...
        newVelocity = APF.CalculatePreferredVelocity(waypoint);
    }

    private void NavigateToWaypointAPF(Vector3 waypoint)
    {
    ...
    void FixedUpdate()
    {
        ...
        */
        ...
        {
            NavigateToWaypointAPF(waypoints[waypointIndex]);
        }
